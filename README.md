...
Build 8 bundles ARM64 libretro cores for NES/Famicom (FCEUmm), SNES (Snes9x), Genesis/Mega Drive (Genesis Plus GX), and PlayStation 1 (PCSX-ReARMed). PSP, N64, Dreamcast, GameCube/Wii, and PS2 are registered through PPSSPP, Mupen64Plus-Next, Flycast, Dolphin, and Play! respectively. The validated hardware path prefers Vulkan when implemented by a core and uses the GLES3 fallback for these Android hardware cores.
