...
data class SystemDefinition(
    ...
    /** Identifier of the libretro core used by this system, when one is bundled. */
...
object Systems {
    val all = listOf(
        SystemDefinition("gba", "GBA", "Game Boy Advance", "mGBA", setOf("gba", "zip", "7z"), coreId = "mgba"),
        SystemDefinition("gbc", "GB / GBC", "Game Boy / Color", "mGBA", setOf("gb", "gbc", "zip", "7z"), coreId = "mgba"),
        SystemDefinition("nes", "NES", "NES / Famicom", "FCEUmm", setOf("nes", "fds", "unf", "unif", "zip", "7z"), coreId = "fceumm"),
        SystemDefinition("snes", "SNES", "Super Nintendo", "Snes9x", setOf("sfc", "smc", "fig", "gd3", "gd7", "dx2", "bsx", "swc", "zip", "7z"), coreId = "snes9x"),
        SystemDefinition("genesis", "GENESIS", "Genesis / Mega Drive", "Genesis Plus GX", setOf("md", "gen", "bin", "smd", "zip", "7z"), coreId = "genesis_plus_gx"),
        SystemDefinition("atari2600", "ATARI", "Atari 2600", "Stella 2014", setOf("a26", "bin", "rom", "zip", "7z")),
        SystemDefinition("n64", "N64", "Nintendo 64", "Mupen64Plus-Next", setOf("z64", "n64", "v64", "zip", "7z"), coreId = "mupen64plus_next_gles3"),
        SystemDefinition("nds", "NDS", "Nintendo DS", "DeSmuME", setOf("nds", "zip", "7z")),
        SystemDefinition("psp", "PSP", "PlayStation Portable", "PPSSPP", setOf("iso", "cso", "pbp", "zip", "7z"), coreId = "ppsspp"),
        SystemDefinition("ps1", "PS1", "PlayStation", "PCSX-ReARMed", setOf("chd", "bin", "cue", "img", "mdf", "pbp", "toc", "cbn", "m3u", "ccd", "zip", "7z"), true, coreId = "pcsx_rearmed"),
